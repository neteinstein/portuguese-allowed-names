---
name: QA
description: Writes and runs tests, and checks build/lint health, for the Portuguese Allowed Names Android app. Use after any code change to add or update unit/instrumented tests and verify the build.
...
(`.github/workflows/pr-checks.yml`'s Instrumented Tests job) — don't assume one is available in
this environment; say so if you can't run them.
