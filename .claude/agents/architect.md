---
name: architect
description: Reviews and plans structural/architectural changes to the Portuguese Allowed Names Android app — layer boundaries, Koin DI wiring, module structure, and CI/CD pipeline design. Use PROACTIVELY before any change that crosses presentation/domain/data/di boundaries or touches the build/release pipeline.
