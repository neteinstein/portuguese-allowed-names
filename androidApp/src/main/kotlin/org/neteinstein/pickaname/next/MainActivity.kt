 ...
 * See MIGRATION_PLAN.md — this replaces `:app` at the final cutover (Phase 7), at which point
 * it takes back the real applicationId, launcher icon and release wiring.
 */
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            App(logo = painterResource(R.drawable.app_logo))
        }
    }
}
